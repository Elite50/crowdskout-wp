...
if (!function_exists('cskt_social_explain')) {
    /** The explanation for the settings we need for social media tracking. */
    function cskt_social_explain() {
        _e('The settings we need to start tracking your newsletter sign-ups and social media interactions.', 'crowdskout');
