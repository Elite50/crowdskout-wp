// crowdskout-wp admin side js library
var cskt_admin = {};

(function($) {
    // accordion menu for widget
    cskt_admin.accordionMenu = function() {
    ...
    // make a call to the jquery-ui for sortable menu elements for accordion menu in the widget
    $(function() {
